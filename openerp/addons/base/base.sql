...
-- Default data
---------------------------------
insert into res_currency (id, name) VALUES (1, 'VND');
insert into ir_model_data (name, module, model, noupdate, res_id) VALUES ('VND', 'base', 'res.currency', true, 1);
select setval('res_currency_id_seq', 2);

insert into res_company (id, name, partner_id, currency_id) VALUES (1, 'CTTMS', 1, 1);
...
insert into res_partner (id, name, company_id) VALUES (1, 'CTTMS', 1);
