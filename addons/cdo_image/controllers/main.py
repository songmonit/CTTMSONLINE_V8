...
class Binary_multi(Binary):
    ...
    def upload_image_multi(self, req, callback, ufile):
        ...
        if data:
            ...
            addons_path = openerpweb.addons_manifest['web']['addons_path'] + "/web/static/src/img/cdo_image/"
            ...
            buff.write(data)
            buff.seek(0)
            file_name = "/web/static/src/img/cdo_image/" + file_name
